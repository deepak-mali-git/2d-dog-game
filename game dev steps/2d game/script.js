window.addEventListener("load", function () {
  ...
  class Player {
    constructor(gameWidth,gameHeight){
      ...
      this.image = document.getElementById('plyerImage');
      this.frameX = 0;
      this.maxFrame = 8;
      this.frameY = 0;
      this.fps = 20;
  ...
  function displayStatusText(context) {
    ...
    if (gameOver){
      ...
      context.fillStyle = 'black';
      context.fillText('GAME OVER , ENTER TO RESTART',canvas.width/2,200);
      context.fillStyle = 'white';
      context.fillText('GAME OVER , ENTER TO RESTART',canvas.width/2 + 2,202);
    }
  }
